...
gitbr() {
  ...
  # [[ $(git status 2> /dev/null | tail -n1) =~ "nothing to commit" ]] || echo -e " *"
}
...
if [ "$color_prompt" = yes ]; then
  PS1='\[\033[01;35m\][$?]${debian_chroot:+($debian_chroot)}\[\033[01;32m\]\u\[\033[01;34m\]\w\[\033[33m\]$(gitbr) \[\033[00m\] '
else
    PS1='\[\033[01;35m\][$?]${debian_chroot:+($debian_chroot)}\u \w\[\033[33m\]$(gitbr)\[\033[00m\] '
fi
...
alias gitlog='git log --oneline --decorate --tags --graph'
